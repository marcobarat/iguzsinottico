sap.ui.define([
    ...
    var IlaPressMix = Control.extend("plantvim.component.IlaPressMix", {
        metadata: {
            properties: {
                "width": {
                ...
                "gaugeStyle": {
                    type: "string", defaultValue: "width:160px; height:60px"
                },
                "mnumber": {
        ...
        onAfterRendering: function () {
            ...
            jQuery.sap.byId(this.getId() + "img1").click(function(evt) {
                that.firePress({resource: that.getMnumber(), img: that.getImageUrl(), type: "assembly"});
            });
